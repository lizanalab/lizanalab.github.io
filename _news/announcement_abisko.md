...
<div class="row justify-content-sm-center">
  <div class="col-sm-8 mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/northern-ligt.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
  </div>
  <div class="col-sm-4 mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/stint-icelab-NRF-logo-flags.svg" title="example image" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
...
### Organizers
Hye Jin Park, Inha Univ.,<br>
Eric Libby, IceLab,<br>
